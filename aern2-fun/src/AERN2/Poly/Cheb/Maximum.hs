...
maximum (ChPoly dom poly) l r  =
   Pow.genericMaximum (evalDf f f') (Map.fromList [(0, f')])
...
maximumOptimised f l r initialDegree steps =
  Pow.maximumOptimised (cheb2Power $ chPoly_poly f) l r initialDegree steps  -- TODO: evaluate in Chebyshev basis - this requires a good evaluation function
