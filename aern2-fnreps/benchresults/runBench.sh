...
function rungePPoly
{
    ...
    op=integrate
    for params in "100 0 0.1 1 100" "100 0 0.1 2 100" "150 0 0.1 3 150" "150 0 0.01 3 150" "300 0 0.05 4 300" "300 0 0.01 4 300"
    do
        runOne
    done
...
function fracSinPPoly
{
    ...
    op=max
    for params in "100 20 0.5 1 100" "100 20 0.1 1 100" "100 30 0.1 2 100" "800 40 0.1 3 200" "800 40 0.05 3 200"
    do
        runOne
    done
    
    op=integrate
    for params in "100 20 0.5 1 100" "100 20 0.1 1 100" "100 30 0.1 2 100" "800 40 0.1 3 200"
    do
        runOne
    done
