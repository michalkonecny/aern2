...
var _bartavelle$json_helpers$Json_Helpers$decodeSumUnaries = F2(
		...
		if (_p6.ctor === 'EValue') {
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						kp,
						{ctor: '_Tuple2', _0: contentname, _1: _p6._0}
					]));
		} else {
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List_ops['::'], kp, _p6._0));
		}
	});
...
var _bartavelle$json_helpers$Json_Helpers$decodeSumTaggedObject = F5(
	function (name, fieldname, contentname, mapping, objectKeys) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_elm_lang$core$Json_Decode_ops[':='], fieldname, _elm_lang$core$Json_Decode$string),
			function (key) {
				var decoder = A2(_elm_lang$core$Set$member, key, objectKeys) ? _elm_lang$core$Json_Decode$value : A2(_elm_lang$core$Json_Decode_ops[':='], contentname, _elm_lang$core$Json_Decode$value);
				return A2(
...
var _bartavelle$json_helpers$Json_Helpers$decodeSumTwoElemArray = F2(
	function (name, mapping) {
		return A2(
			...
			function (_p8) {
				var _p9 = _p8;
				return A4(_bartavelle$json_helpers$Json_Helpers$decodeSumFinal, name, _p9._0, _p9._1, mapping);
			});
	});
		...
		if (_p11.ctor === '[]') {
			...
			return A2(
				...
				function (nx) {
					return A2(
						_elm_lang$core$Result$andThen,
						A2(_bartavelle$json_helpers$Json_Helpers$resmapM, f, _p11._1),
						function (nxs) {
							return _elm_lang$core$Result$Ok(
								A2(_elm_lang$core$List_ops['::'], nx, nxs));
						});
				});
		}
	});
var _bartavelle$json_helpers$Json_Helpers$decodeMap = F2(
	function (decKey, decVal) {
		var decodeKey = function (_p12) {
			var _p13 = _p12;
			return A2(
				_elm_lang$core$Result$map,
				function (nk) {
					return {ctor: '_Tuple2', _0: nk, _1: _p13._1};
				},
				A2(_elm_lang$core$Json_Decode$decodeString, decKey, _p13._0));
		};
...
var _bartavelle$json_helpers$Json_Helpers$oeValue = function (x) {
	var _p15 = x;
	if (_p15.ctor === 'EObject') {
		return _elm_lang$core$Json_Encode$object(_p15._0);
	} else {
		return _p15._0;
	}
};
		...
		return _elm_lang$core$Json_Encode$list(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_bartavelle$json_helpers$Json_Helpers$oeValue(val)
				]));
	});
...
var _user$project$QANetLog$jsonEncValueId = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$int(_p1._0);
};
var _user$project$QANetLog$jsonEncQANetLogItem = function (val) {
		...
		switch (_p2.ctor) {
			case 'QANetLogCreate':
				...
				return {
					ctor: '_Tuple2',
					_0: 'QANetLogCreate',
					_1: _bartavelle$json_helpers$Json_Helpers$encodeObject(
						_elm_lang$core$Native_List.fromArray(
							[
								{
								ctor: '_Tuple2',
								_0: 'qaLogCreate_newId',
								_1: _user$project$QANetLog$jsonEncValueId(_p4.qaLogCreate_newId)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogCreate_sources',
								_1: function (_p3) {
									return _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _user$project$QANetLog$jsonEncValueId, _p3));
								}(_p4.qaLogCreate_sources)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogCreate_name',
								_1: _elm_lang$core$Json_Encode$string(_p4.qaLogCreate_name)
							}
							]))
				};
			case 'QANetLogQuery':
					...
					_1: _bartavelle$json_helpers$Json_Helpers$encodeObject(
						_elm_lang$core$Native_List.fromArray(
							[
								{
								ctor: '_Tuple2',
								_0: 'qaLogQuery_client',
								_1: A2(_bartavelle$json_helpers$Json_Helpers$maybeEncode, _user$project$QANetLog$jsonEncValueId, _p5.qaLogQuery_client)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogQuery_provider',
								_1: _user$project$QANetLog$jsonEncValueId(_p5.qaLogQuery_provider)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogQuery_description',
								_1: _elm_lang$core$Json_Encode$string(_p5.qaLogQuery_description)
							}
							]))
				};
			default:
					...
					_1: _bartavelle$json_helpers$Json_Helpers$encodeObject(
						_elm_lang$core$Native_List.fromArray(
							[
								{
								ctor: '_Tuple2',
								_0: 'qaLogAnswer_client',
								_1: A2(_bartavelle$json_helpers$Json_Helpers$maybeEncode, _user$project$QANetLog$jsonEncValueId, _p6.qaLogAnswer_client)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogAnswer_provider',
								_1: _user$project$QANetLog$jsonEncValueId(_p6.qaLogAnswer_provider)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogAnswer_cacheUseDescription',
								_1: _elm_lang$core$Json_Encode$string(_p6.qaLogAnswer_cacheUseDescription)
							},
								{
								ctor: '_Tuple2',
								_0: 'qaLogAnswer_description',
								_1: _elm_lang$core$Json_Encode$string(_p6.qaLogAnswer_description)
							}
							]))
				};
		}
...
var _user$project$QANetLog$QANetLogAnswer = function (a) {
	return {ctor: 'QANetLogAnswer', _0: a};
};
var _user$project$QANetLog$QANetLogQuery = function (a) {
	return {ctor: 'QANetLogQuery', _0: a};
};
var _user$project$QANetLog$QANetLogCreate = function (a) {
	return {ctor: 'QANetLogCreate', _0: a};
};
var _user$project$QANetLog$ValueId = function (a) {
	return {ctor: 'ValueId', _0: a};
};
var _user$project$QANetLog$jsonDecValueId = A2(_elm_lang$core$Json_Decode$map, _user$project$QANetLog$ValueId, _elm_lang$core$Json_Decode$int);
var _user$project$QANetLog$jsonDecQANetLogItem = function () {
	var jsonDecDictQANetLogItem = _elm_lang$core$Dict$fromList(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				...
				_1: A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$QANetLog$QANetLogCreate,
					A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogCreate_newId', _user$project$QANetLog$jsonDecValueId),
						function (pqaLogCreate_newId) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(
									_elm_lang$core$Json_Decode_ops[':='],
									'qaLogCreate_sources',
									_elm_lang$core$Json_Decode$list(_user$project$QANetLog$jsonDecValueId)),
								function (pqaLogCreate_sources) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogCreate_name', _elm_lang$core$Json_Decode$string),
										function (pqaLogCreate_name) {
											return _elm_lang$core$Json_Decode$succeed(
												{qaLogCreate_newId: pqaLogCreate_newId, qaLogCreate_sources: pqaLogCreate_sources, qaLogCreate_name: pqaLogCreate_name});
										});
								});
						}))
			},
				...
				_1: A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$QANetLog$QANetLogQuery,
					A2(
						_elm_lang$core$Json_Decode$andThen,
						_elm_lang$core$Json_Decode$maybe(
							A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogQuery_client', _user$project$QANetLog$jsonDecValueId)),
						function (pqaLogQuery_client) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogQuery_provider', _user$project$QANetLog$jsonDecValueId),
								function (pqaLogQuery_provider) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogQuery_description', _elm_lang$core$Json_Decode$string),
										function (pqaLogQuery_description) {
											return _elm_lang$core$Json_Decode$succeed(
												{qaLogQuery_client: pqaLogQuery_client, qaLogQuery_provider: pqaLogQuery_provider, qaLogQuery_description: pqaLogQuery_description});
										});
								});
						}))
			},
				...
				_1: A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$QANetLog$QANetLogAnswer,
					A2(
						_elm_lang$core$Json_Decode$andThen,
						_elm_lang$core$Json_Decode$maybe(
							A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogAnswer_client', _user$project$QANetLog$jsonDecValueId)),
						function (pqaLogAnswer_client) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogAnswer_provider', _user$project$QANetLog$jsonDecValueId),
								function (pqaLogAnswer_provider) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogAnswer_cacheUseDescription', _elm_lang$core$Json_Decode$string),
										function (pqaLogAnswer_cacheUseDescription) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
												A2(_elm_lang$core$Json_Decode_ops[':='], 'qaLogAnswer_description', _elm_lang$core$Json_Decode$string),
												function (pqaLogAnswer_description) {
													return _elm_lang$core$Json_Decode$succeed(
														{qaLogAnswer_client: pqaLogAnswer_client, qaLogAnswer_provider: pqaLogAnswer_provider, qaLogAnswer_cacheUseDescription: pqaLogAnswer_cacheUseDescription, qaLogAnswer_description: pqaLogAnswer_description});
												});
										});
								});
						}))
	...
	return A2(_bartavelle$json_helpers$Json_Helpers$decodeSumObjectWithSingleField, 'QANetLogItem', jsonDecDictQANetLogItem);
}();

var _user$project$Main$bgrColour = A3(_elm_lang$core$Color$rgb, 200, 255, 220);
var _user$project$Main$nodeH = 0.1;
var _user$project$Main$nodeW = 0.16;
var _user$project$Main$fromValueId = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Main$getNodeInfoPos = F2(
	function (s, vId) {
		var _p2 = A2(
			_elm_lang$core$Dict$get,
			_user$project$Main$fromValueId(vId),
			s.nodes);
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			...
			if (_p3.ctor === 'Nothing') {
				...
				var _p4 = s.plotCanvasSize;
				var width = _p4.width;
				var height = _p4.height;
				var w = _elm_lang$core$Basics$toFloat(width);
				var h = _elm_lang$core$Basics$toFloat(height);
				return _elm_lang$core$Maybe$Just(
					{
						ctor: '_Tuple2',
						_0: _p5,
						_1: {ctor: '_Tuple2', _0: (_p3._0._0 - 0.5) * w, _1: (_p3._0._1 - 0.5) * h}
					});
			}
		}
	});
var _user$project$Main$drawLink = F4(
	function (s, c, destId, srcId) {
		var _p6 = {
			ctor: '_Tuple2',
			_0: A2(_user$project$Main$getNodeInfoPos, s, srcId),
			_1: A2(_user$project$Main$getNodeInfoPos, s, destId)
		};
		if (((((((_p6.ctor === '_Tuple2') && (_p6._0.ctor === 'Just')) && (_p6._0._0.ctor === '_Tuple2')) && (_p6._0._0._1.ctor === '_Tuple2')) && (_p6._1.ctor === 'Just')) && (_p6._1._0.ctor === '_Tuple2')) && (_p6._1._0._1.ctor === '_Tuple2')) {
			var _p13 = _p6._0._0._1._1;
			var _p12 = _p6._0._0._1._0;
			var _p11 = _p6._1._0._1._1;
			var _p10 = _p6._1._0._1._0;
			var _p9 = _p6._1._0._0;
			var srcN = _elm_lang$core$List$length(_p9.sources);
			var msrcK = _elm_lang$core$Maybe$oneOf(
				A3(
					_elm_lang$core$List$map2,
					F2(
						function (k, sId) {
							return _elm_lang$core$Native_Utils.eq(sId, srcId) ? _elm_lang$core$Maybe$Just(k) : _elm_lang$core$Maybe$Nothing;
						}),
					_elm_lang$core$Native_List.range(0, srcN - 1),
					_p9.sources));
			var srcK = function () {
				var _p7 = msrcK;
				if (_p7.ctor === 'Just') {
			...
			var _p8 = s.plotCanvasSize;
			var width = _p8.width;
			var height = _p8.height;
			var w = _elm_lang$core$Basics$toFloat(width);
			var nw = _user$project$Main$nodeW * w;
			var h = _elm_lang$core$Basics$toFloat(height);
			var nh = _user$project$Main$nodeH * h;
			var destYK = (_elm_lang$core$Native_Utils.cmp(srcN, 1) < 1) ? _p11 : (_p11 + ((0.4 * nh) * (0.5 - (_elm_lang$core$Basics$toFloat(srcK) / (_elm_lang$core$Basics$toFloat(srcN) - 1)))));
			return _elm_lang$core$Native_List.fromArray(
				[
					A2(
					_evancz$elm_graphics$Collage$traced,
					_evancz$elm_graphics$Collage$solid(c),
					_evancz$elm_graphics$Collage$path(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: _p12 + (nw * 0.5), _1: _p13},
								{ctor: '_Tuple2', _0: _p12 + (nw * 0.55), _1: _p13},
								{ctor: '_Tuple2', _0: _p10 - (nw * 0.55), _1: destYK},
								{ctor: '_Tuple2', _0: _p10 - (nw * 0.5), _1: destYK}
							])))
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$drawNode = F2(
	function (s, _p14) {
		var _p15 = _p14;
		var _p19 = _p15._0;
		var _p16 = A2(
			_user$project$Main$getNodeInfoPos,
			s,
			_user$project$QANetLog$ValueId(_p19));
		if (_p16.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var _p18 = _p16._0._0;
			var srcN = _elm_lang$core$List$length(_p18.sources);
			var _p17 = s.plotCanvasSize;
			var width = _p17.width;
			var height = _p17.height;
			var w = _elm_lang$core$Basics$toFloat(width);
			var nw = _user$project$Main$nodeW * w;
			var h = _elm_lang$core$Basics$toFloat(height);
			var nh = _user$project$Main$nodeH * h;
			var nodeBox = A2(_evancz$elm_graphics$Collage$rect, nw, nh);
			var nameBox = A2(_evancz$elm_graphics$Collage$rect, nw, 0.3 * nh);
			var nameMove = _evancz$elm_graphics$Collage$move(
				{ctor: '_Tuple2', _0: 0.0, _1: 0.35 * nh});
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_evancz$elm_graphics$Collage$group(
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_evancz$elm_graphics$Collage$filled, _elm_lang$core$Color$white, nodeBox),
									nameMove(
									A2(
										_evancz$elm_graphics$Collage$filled,
										A3(_elm_lang$core$Color$rgb, 200, 220, 255),
										nameBox)),
									nameMove(
									A2(
									...
									A2(
									_evancz$elm_graphics$Collage$move,
									{ctor: '_Tuple2', _0: 0.0, _1: nh * 0.4},
									A2(
										_evancz$elm_graphics$Collage$scale,
										h / 500.0,
										_evancz$elm_graphics$Collage$text(
											_evancz$elm_graphics$Text$fromString(_p18.name))))
								])))
					]),
...
var _user$project$Main$drawEvent = F2(
	function (s, event) {
		var _p20 = s.plotCanvasSize;
		...
		var h = _elm_lang$core$Basics$toFloat(height);
		var nh = _user$project$Main$nodeH * h;
		var drawQuery = function (q) {
			var _p21 = A2(_user$project$Main$getNodeInfoPos, s, q.qaLogQuery_provider);
								...
								A2(
									...
									_evancz$elm_graphics$Collage$text(
										A2(
											...
											_evancz$elm_graphics$Text$fromString(
												A2(_elm_lang$core$Basics_ops['++'], '? ', q.qaLogQuery_description)))))))
						]),
					function () {
						var _p22 = q.qaLogQuery_client;
						if (_p22.ctor === 'Nothing') {
							return _elm_lang$core$Native_List.fromArray(
								[]);
						} else {
							return A4(_user$project$Main$drawLink, s, _elm_lang$core$Color$red, _p22._0, q.qaLogQuery_provider);
						}
					}());
			}
		};
		var drawAnswer = function (a) {
			var _p23 = A2(_user$project$Main$getNodeInfoPos, s, a.qaLogAnswer_provider);
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								_evancz$elm_graphics$Collage$move,
								{ctor: '_Tuple2', _0: 0.0, _1: (0 - nh) * 0.3},
								A2(
									_evancz$elm_graphics$Collage$scale,
									h / 500.0,
									_evancz$elm_graphics$Collage$text(
										A2(
											...
											_elm_lang$core$Color$red,
											_evancz$elm_graphics$Text$fromString(
												A2(_elm_lang$core$Basics_ops['++'], '', a.qaLogAnswer_description)))))))
						]),
					function () {
						var _p24 = a.qaLogAnswer_client;
						if (_p24.ctor === 'Nothing') {
							return _elm_lang$core$Native_List.fromArray(
								[]);
						} else {
							return A4(_user$project$Main$drawLink, s, _elm_lang$core$Color$red, _p24._0, a.qaLogAnswer_provider);
						}
					}());
			}
		};
		...
		switch (_p25.ctor) {
			case 'QANetLogCreate':
				return _elm_lang$core$Native_List.fromArray(
					[]);
			case 'QANetLogQuery':
				return drawQuery(_p25._0);
			default:
				return drawAnswer(_p25._0);
		}
	});
var _user$project$Main$drawPendingQueries = F2(
	function (s, pendingQueries) {
		var _p26 = s.plotCanvasSize;
		var width = _p26.width;
		var height = _p26.height;
		var w = _elm_lang$core$Basics$toFloat(width);
		var nw = _user$project$Main$nodeW * w;
		var h = _elm_lang$core$Basics$toFloat(height);
		var nh = _user$project$Main$nodeH * h;
		var drawQuery = function (q) {
			var _p27 = A2(_user$project$Main$getNodeInfoPos, s, q.qaLogQuery_provider);
		...
		return _elm_lang$core$List$concat(
			A2(_elm_lang$core$List$map, drawQuery, pendingQueries));
	});
var _user$project$Main$drawCachedAnswers = F2(
	function (s, events) {
		var _p28 = s.plotCanvasSize;
		var width = _p28.width;
		var height = _p28.height;
		var w = _elm_lang$core$Basics$toFloat(width);
		var nw = _user$project$Main$nodeW * w;
		var h = _elm_lang$core$Basics$toFloat(height);
		var nh = _user$project$Main$nodeH * h;
		var drawAnswer = function (event) {
			var _p29 = event;
			if (_p29.ctor === 'QANetLogAnswer') {
				var _p31 = _p29._0;
				var _p30 = A2(_user$project$Main$getNodeInfoPos, s, _p31.qaLogAnswer_provider);
						...
						[
							...
							A2(
								...
								A2(
									...
									_evancz$elm_graphics$Collage$text(
										_evancz$elm_graphics$Text$fromString(
											A2(_elm_lang$core$Basics_ops['++'], '', _p31.qaLogAnswer_description))))))
						]);
				}
			} else {
				return _elm_lang$core$Native_List.fromArray(
		...
		return _elm_lang$core$List$concat(
			A2(_elm_lang$core$List$map, drawAnswer, events));
	});
var _user$project$Main$filterPendingQueries = function () {
	var aux = F2(
		function (prevQueries, events) {
			aux:
			while (true) {
				var _p32 = events;
				if (_p32.ctor === '[]') {
					return _elm_lang$core$Dict$values(prevQueries);
				} else {
					switch (_p32._0.ctor) {
						case 'QANetLogQuery':
							var _p33 = _p32._0._0;
							var _v16 = A3(
								_elm_lang$core$Dict$insert,
								_user$project$Main$fromValueId(_p33.qaLogQuery_provider),
								_p33,
								prevQueries),
								_v17 = _p32._1;
							prevQueries = _v16;
						...
						case 'QANetLogAnswer':
							var _v18 = A2(
								...
								_user$project$Main$fromValueId(_p32._0._0.qaLogAnswer_provider),
								prevQueries),
								_v19 = _p32._1;
							prevQueries = _v18;
							events = _v19;
	...
	return aux(_elm_lang$core$Dict$empty);
}();
var _user$project$Main$view = function (s) {
	var pendingQueries = _user$project$Main$filterPendingQueries(
		_elm_lang$core$List$reverse(s.eventsDone));
	var _p34 = s.plotCanvasSize;
	var width = _p34.width;
	var height = _p34.height;
	return A2(
							...
							A2(
								...
								A2(
									...
									_elm_lang$core$List$concat(
										A2(
											_elm_lang$core$List$map,
											_user$project$Main$drawNode(s),
											_elm_lang$core$Dict$toList(s.nodes))),
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_user$project$Main$drawPendingQueries, s, pendingQueries),
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(_user$project$Main$drawCachedAnswers, s, s.eventsDone),
											function () {
												var _p36 = s.eventsTodo;
												if (_p36.ctor === '::') {
													return A2(_user$project$Main$drawEvent, s, _p36._0);
												} else {
													return _elm_lang$core$Native_List.fromArray(
														[]);
												}
...
var _user$project$Main$isQANetLogCreate = function (logItem) {
	var _p37 = logItem;
	if (_p37.ctor === 'QANetLogCreate') {
		return true;
	} else {
		return false;
	}
};
var _user$project$Main$getNodeInfo = F2(
	function (log, nodepositions) {
		var getCreate = function (logItem) {
			var _p38 = logItem;
			if (_p38.ctor === 'QANetLogCreate') {
				return _elm_lang$core$Native_List.fromArray(
					[_p38._0]);
			} else {
				return _elm_lang$core$Native_List.fromArray(
		...
		var nodeposDict = _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (_p39) {
					var _p40 = _p39;
					return {
						ctor: '_Tuple2',
						_0: _p40._0,
						_1: {ctor: '_Tuple2', _0: _p40._1, _1: _p40._2}
					};
				},
				nodepositions));
		var makeNodeInfo = function (c) {
			var cId = _user$project$Main$fromValueId(c.qaLogCreate_newId);
			var pos = function () {
				var _p41 = A2(_elm_lang$core$Dict$get, cId, nodeposDict);
				if (_p41.ctor === 'Just') {
			...
			return {name: c.qaLogCreate_name, sources: c.qaLogCreate_sources, pos: pos};
		};
		return _elm_lang$core$Dict$fromList(
			A2(
				...
				function (c) {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Main$fromValueId(c.qaLogCreate_newId),
						_1: makeNodeInfo(c)
					};
				},
				_elm_lang$core$List$concat(
					A2(_elm_lang$core$List$map, getCreate, log))));
	});
			...
			case 'Err':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						s,
						{
							err: _elm_lang$core$Maybe$Just(_p42._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'NextEvent':
				var _p43 = s.eventsTodo;
				if (_p43.ctor === '::') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							...
							{
								eventsTodo: _p43._1,
								eventsDone: A2(_elm_lang$core$List_ops['::'], _p43._0, s.eventsDone)
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				} else {
				...
				if (_p44.ctor === '::') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								eventsDone: _p44._1,
								eventsTodo: A2(_elm_lang$core$List_ops['::'], _p44._0, s.eventsTodo)
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				} else {
...
var _user$project$Main$jsonDecNodePos = A4(
	...
	_elm_lang$core$Json_Decode$float);
var _user$project$Main$jsonDecNodePositions = _elm_lang$core$Json_Decode$list(_user$project$Main$jsonDecNodePos);
var _user$project$Main$jsonDecQANetLog = _elm_lang$core$Json_Decode$list(_user$project$QANetLog$jsonDecQANetLogItem);
var _user$project$Main$initState = function (flags) {
	var nodepositionsR = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$jsonDecNodePositions, flags.nodeposS);
	var logR = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$jsonDecQANetLog, flags.netlogS);
	var _p45 = {ctor: '_Tuple2', _0: logR, _1: nodepositionsR};
	if (((_p45.ctor === '_Tuple2') && (_p45._0.ctor === 'Ok')) && (_p45._1.ctor === 'Ok')) {
		var _p47 = _p45._0._0;
		return {
			err: _elm_lang$core$Maybe$Nothing,
			log: _elm_lang$core$Maybe$Just(_p47),
			plotCanvasSize: {width: 800, height: 600},
			nodes: A2(_user$project$Main$getNodeInfo, _p47, _p45._1._0),
			eventsDone: _elm_lang$core$Native_List.fromArray(
				[]),
			eventsTodo: A2(
				_elm_lang$core$List$filter,
				function (_p46) {
					return _elm_lang$core$Basics$not(
						_user$project$Main$isQANetLogCreate(_p46));
				},
				_p47)
		};
	} else {
		return {
			err: _elm_lang$core$Maybe$Just(
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(logR),
					_elm_lang$core$Basics$toString(nodepositionsR))),
			log: _elm_lang$core$Maybe$Nothing,
			plotCanvasSize: {width: 800, height: 600},
			nodes: _elm_lang$core$Dict$empty,
			eventsDone: _elm_lang$core$Native_List.fromArray(
				[]),
			eventsTodo: _elm_lang$core$Native_List.fromArray(
				[])
		};
	}
};
var _user$project$Main$State = F6(
	function (a, b, c, d, e, f) {
		return {err: a, log: b, plotCanvasSize: c, nodes: d, eventsDone: e, eventsTodo: f};
	});
var _user$project$Main$NodeInfo = F3(
	function (a, b, c) {
		return {name: a, sources: b, pos: c};
	});
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {netlogS: a, nodeposS: b};
	});
var _user$project$Main$PrevEvent = {ctor: 'PrevEvent'};
var _user$project$Main$NextEvent = {ctor: 'NextEvent'};
...
var _user$project$Main$NoAction = {ctor: 'NoAction'};
var _user$project$Main$subscriptions = function (s) {
	var keyEvent = function (code) {
		var _p48 = _elm_lang$core$Char$fromCode(code);
		switch (_p48.valueOf()) {
			case 'q':
				return _user$project$Main$PrevEvent;
			case 'w':
				return _user$project$Main$NextEvent;
			default:
				return _user$project$Main$NoAction;
		}
	};
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$presses(keyEvent),
				_elm_lang$window$Window$resizes(_user$project$Main$Resize)
			]));
};
var _user$project$Main$simulateResize = A3(
	...
	_elm_lang$window$Window$size);
var _user$project$Main$initCmds = _elm_lang$core$Native_List.fromArray(
	[_user$project$Main$simulateResize]);
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: function (flags) {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$Main$initState(flags),
					_user$project$Main$initCmds);
			},
	...
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'netlogS', _elm_lang$core$Json_Decode$string),
		function (netlogS) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'nodeposS', _elm_lang$core$Json_Decode$string),
				function (nodeposS) {
					return _elm_lang$core$Json_Decode$succeed(
						{netlogS: netlogS, nodeposS: nodeposS});
				});
		})
};
