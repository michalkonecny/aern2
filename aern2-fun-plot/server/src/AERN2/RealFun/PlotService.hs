{-|
    ...
    Description :  Backend for plotting unary real functions
...
type Api =
  "api" :>
    ("sampling" :> Get '[JSON] [SamplingId] :<|>
     "sampling" :> ReqBody '[JSON] String :> Post '[JSON] SamplingId :<|>
     "sampling" :> Capture "samplingId" SamplingId :> Get '[JSON] Sampling :<|>
     "function" :> Get '[JSON] [FunctionName] :<|>
